...
public class MainActivity extends AppCompatActivity
    ...
    private ArrayList<MovieBriefDetails> list_movies = new ArrayList<>();
    private ArrayList<MovieBriefDetails> test = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            this.list_movies = (ArrayList<MovieBriefDetails>) savedInstanceState.getSerializable("movie_list");
        } else {
            loadMore(5);
    ...
    private void sendJSONRequest() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(url, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Collections.sort(list_movies, new Comparator<MovieBriefDetails>() {
                    @Override
    ...
    private ArrayList<MovieBriefDetails> parseJSONResponse(JSONObject response) {
...
//                    Toast.makeText(MainActivity.this, "Id already exists " + id, Toast.LENGTH_SHORT).show();
                ...
                movie = new MovieBriefDetails(id, title, genres, year, rating, url_movie_cover);
...
//        Toast.makeText(MainActivity.this,url,Toast.LENGTH_LONG).show();
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putSerializable("movie_list", list_movies);
    }
